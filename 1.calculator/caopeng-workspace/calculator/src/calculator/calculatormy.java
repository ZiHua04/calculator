...
public class calculatormy {
    public void calculatorpanel() {
        ...
        // 5. 创建中间容器（面板容器）
        // 创建面板容器，使用默认的布局管理器
        //同时请勿使用jpanel中flowlayout流式排版进行实现//默认为5个单位
        JPanel panel = new JPanel(new GridLayout(5,3));
        //gridlayout表示 网格布局 ，能过够实现按钮 布满全局 的功能
    ...
    public static void main(String[] args) {
        calculatormy a=new calculatormy();//创建一个calculator
        a.calculatorpanel();//function
    }
}
